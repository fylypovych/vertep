...
- Збирає Docker-образи, ставить тег на SHA цього самого коміту.
...
- Заборонено: використовувати образи від іншої версії, вручну перезаписувати тег, публікувати якщо хоча б один образ не зібрався, посилатися лише на `latest`.
