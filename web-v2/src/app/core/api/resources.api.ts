...
export class ResourcesApiService {
  ...
  createBrand = (p: BrandCreateDTO): Observable<Brand> => this.http.post<Brand>(`${this.base.url}/brands`, p, { headers: this.h() }).pipe(catchError(this.base.handleError));
  updateBrand = (id: string, p: BrandUpdateDTO): Observable<Brand> => this.http.put<Brand>(`${this.base.url}/brands/${this.base.enc(id)}`, p, { headers: this.h() }).pipe(catchError(this.base.handleError));
  ...
  saveWorkflow = (kind: string, name: string, p: Record<string, unknown>): Observable<WorkflowSaveResponse> => this.http.put<WorkflowSaveResponse>(`${this.base.url}/workflows/${this.base.enc(kind)}/${this.base.enc(name)}`, p, { headers: this.h() }).pipe(catchError(this.base.handleError));
  deleteWorkflow = (kind: string, name: string): Observable<WorkflowDeleteResponse> => this.http.delete<WorkflowDeleteResponse>(`${this.base.url}/workflows/${this.base.enc(kind)}/${this.base.enc(name)}`, { headers: this.h() }).pipe(catchError(this.base.handleError));
